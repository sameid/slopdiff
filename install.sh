...
BASE_URL="https://cdn.sameidusmani.com/slopdiff/bin/v0.1.2"

echo ""
echo -e "${BOLD}${CYAN}  ◉ slopdiff installer v0.1.2${RESET}"
echo ""
...
echo ""
echo -e "${GREEN}  ✓ slopdiff v0.1.2 installed!${RESET}"
echo ""
